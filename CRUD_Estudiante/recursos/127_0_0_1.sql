...
--
-- Estructura de tabla para la tabla `tb_datos_estudiantes`
--

CREATE TABLE `tb_datos_estudiantes` (
...
--
-- Volcado de datos para la tabla `tb_datos_estudiantes`
--
...
--
-- Indices de la tabla `tb_datos_estudiantes`
--
...
(1, 'Goku', 'kame@house.com', '78565434'),
(2, 'Vegeta', 'vegita@planeta.com', '6789-5678'),
(3, 'Satan', 'salvador@tierra.es', '6784-7845'),
(4, 'Gohan', 'gohan@saiyman.ol', '7654-2345'),
(5, 'Trunks', 'corporacion@capsule.net', '7896-2451');
